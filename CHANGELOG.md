...
- Provided a CLI for generating HTML slides from Markdown.
- Added automatic layout, themes, aspect ratios, and class extensions.
- Added speaker notes, Presenter mode, a timer, and a laser pointer.
- Provided parser and HTML generation APIs for Bun.
